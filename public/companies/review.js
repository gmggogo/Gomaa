...
async function fetchTrips(){
  /*
    Company Review only renders OPEN trips.
    Completed / Cancelled / No Show history belongs to Summary and must not
    be downloaded every 30 seconds.
  */
  const url = "/api/company-review/open";
