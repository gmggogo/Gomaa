...
/* =========================
   SHORT TAX REPORT CACHE
   Same tenant + same date range only.
========================= */

const TAX_REPORT_CACHE_TTL_MS =
  15 * 1000;

const taxReportCache =
  new Map();

function taxCacheKey(
  tenantId,
  from,
  to
){
