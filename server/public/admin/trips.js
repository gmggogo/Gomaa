...
<button onclick="editTrip('${t._id}',this)">Edit</button>

<button onclick="toggleTrip('${t._id}',this)">
${t.disabled?"Enable":"Disable"}
</button>

<button onclick="deleteTrip('${t._id}')">
Delete
</button>
...
alert("Edit system will be enabled later")
...
const disable = btn.innerText==="Disable"
