/* =========================================
FILE: public/admin/reserved-add-stop.js
RESERVED ADD STOP
Final Route Editor
...
const MAX_STOPS = 5;
const REVIEW_URL = "/admin/dispatch-add-trip.html?view=review";

const API_TRIP_BY_ID = id =>
  `/api/trips/${encodeURIComponent(id)}`;

const API_RESERVED_TRIPS = "/api/trips";
...
(function injectStyle(){
  ...
  const old = document.getElementById("reserved-add-stop-dynamic-style");
  if(old) old.remove();

  const style = document.createElement("style");
  style.id = "reserved-add-stop-dynamic-style";
