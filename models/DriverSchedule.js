...
const driverScheduleSchema = new mongoose.Schema({
  ...
  vehicleCategory:{ type:String, default:"GENERIC", trim:true, uppercase:true },
  cdlLicensed:{ type:Boolean, default:false },
  cdlClass:{ type:String, default:"", trim:true, uppercase:true },
  vehicleCapacityLb:{ type:Number, default:0, min:0 },
  liftGate:{ type:Boolean, default:false },
  refrigerated:{ type:Boolean, default:false },
  hazmatEndorsed:{ type:Boolean, default:false },
