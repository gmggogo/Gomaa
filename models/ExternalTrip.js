...
const ExternalStopSchema = new mongoose.Schema(
  {
    ...
    geoKey:{ type:String, default:"" },
    geoAddress:{ type:String, default:"" },
...
const ExternalTripSchema = new mongoose.Schema(
  {
    ...
    /*
      ...
      serviceKey / serviceCode / serviceSuffix:
      operational two-letter code used by Broker Pricing and trip numbers.
    */
    serviceIdentity:{
      type:String,
      default:"",
